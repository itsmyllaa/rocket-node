 ...
 * Essa função deverá buscar dentro do array process.argv a flag desejada, que é a string e retornar 
 * o valor da flag.
 * 
 * O segundo irá importar função e passar a flag desejada.
 * 
